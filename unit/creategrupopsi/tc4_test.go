...
// spesificRequest = true, req = false && min != 0
func Test_TC4(t *testing.T) {
	...
	assert.Equal(t, response.Code, http.StatusBadRequest, "Seharusnya required true && minimal memilih < 1")
}
